...
export type WorkItemType =
  "requirement" | "task" | "defect" | "incident" | "epic";
export type WorkItemStatus =
  "open" | "queued" | "running" | "dispatched" | "done" | "failed";
...
export type GateKey =
  "plan-signoff" | "design-signoff" | "escalation" | "audit-deferral";
...
// Stage Configuration (M2): stage vocabulary, reusable flows, and work-item
// type → flow assignment. See shared/stage-vocabulary.ts for the derivation
// logic shared between get-stage-config and list-stages.
export interface StageVocabularyEntry {
  name: string;
  description: string;
...
export interface StageFlow {
  ...
  name: string;
  stageNames: string[];
  dispatchTemplates: Record<string, string>;
}

export type StageTypeAssignment = Record<string, string>;

export interface StageConfigResponse {
  vocabulary: StageVocabularyEntry[];
  flows: StageFlow[];
  typeAssignment: StageTypeAssignment;
}
