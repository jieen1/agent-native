...
const en = {
  ...
  settings: {
    ...
    vllmTitle: "vLLM / OpenAI-compatible providers",
    vllmSubtitle:
      "Local vLLM or LM Studio can leave the API key blank. To use a remote OpenAI-compatible provider (OpenAI, Groq, DeepSeek, a hosted vLLM behind auth, etc.), add its real API key below.",
    vllmName: "Name",
    vllmBaseUrl: "Base URL",
    vllmModel: "Model",
    vllmApiKey: "API key (optional — leave blank for local vLLM/LM Studio)",
    vllmAdd: "Add endpoint",
    vllmEmpty:
      "No endpoints yet — add a local vLLM/LM Studio server or a remote OpenAI-compatible provider below.",
    activate: "Activate",
    active: "Active",
    ...
    brainMonitorIntervalInvalid:
      "Enter a non-negative whole number of seconds.",
...
const zh: typeof en = {
  ...
  settings: {
    ...
    activeExec: "执行运行时",
    none: "默认(框架引擎)",
    vllmTitle: "vLLM / OpenAI 兼容服务",
    vllmSubtitle:
      "本地 vLLM / LM Studio 可留空 API Key;接入第三方 OpenAI 兼容服务(OpenAI、Groq、DeepSeek 等)请填写对应的真实 API Key。",
    vllmName: "名称",
    vllmBaseUrl: "Base URL",
    vllmModel: "模型",
    vllmApiKey: "API Key(可选 —— 本地 vLLM/LM Studio 可留空)",
    vllmAdd: "添加端点",
    vllmEmpty:
      "还没有端点 —— 在下方添加本地 vLLM/LM Studio,或接入远程 OpenAI 兼容服务。",
    activate: "启用",
    active: "已启用",
  ...
  task: {
    ...
    duration: "耗时",
    statusTrail: "状态历史",
    openDeliverable: "查看交付物",
    openInNewTab: "打开",
    noStatusHistory: "尚无状态变更记录。",
    by: "操作人",
  },
  workflows: {
    title: "工作流",
