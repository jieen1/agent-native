...
const CHAT_STORAGE_KEY = "routines";
          ...
          {navItems.map((item) => {
            ...
            const isActive =
              item.href === "/"
                ? location.pathname === "/"
                : item.href === "/routines"
                  ? // "Routines" owns /routines and /routines/<name>, but NOT the
                    // sibling /routines/keys page (which has its own nav item).
                    location.pathname === "/routines" ||
                    (location.pathname.startsWith("/routines/") &&
                      !location.pathname.startsWith("/routines/keys"))
