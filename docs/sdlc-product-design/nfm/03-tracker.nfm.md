...
**这页回答**：接下来系统会按什么顺序做什么、谁在等待什么、调度现在健康吗。现状此页大半是桩——假暂停、假排序，排队人工门的批准/驳回仍是 toast 桩（QueuePage :536-544）；唯签核/裁决审批卡一路已接真 approve-gate/reject-gate（:546-552，2026-07-16 复核收窄原「假审批」表述）。本设计全部接真。
